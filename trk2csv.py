...
with open(trk_name+'-6-sects_data.csv', 'w') as o6:
    o6.write('sect,type,start_dlong,length,heading,cos_heading,sin_heading,cos_normal,sin_normal,unknown_angle,unknown_counter,ground_fsects,ground_counter,num_wall_fsects')
    for i in range(0,10):
